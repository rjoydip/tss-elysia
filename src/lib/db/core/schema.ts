 ...
 * =============================================================================
 * This file contains the core application schema definitions.
 * All business entities (users, sessions, accounts, subscriptions) are defined here.
 *
 * DO NOT add management/monitoring tables to this file.
 * Use the extended schema directory for additional tables.
 * =============================================================================
 */
...
/**
 * Union type for all core table definitions
 */
export type CoreDBType =
  | typeof users
  | typeof sessions
  | typeof accounts
