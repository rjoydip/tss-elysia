...
This project uses OpenCode AI for automated code review and issue triage.

### Issue Triage

Triggered when a new issue is opened. The workflow:

1. Checks account age (must be 30+ days)
2. Runs OpenCode AI to analyze the issue
3. Provides documentation links and guidance if applicable

### PR Review

Triggered on PR opened/synchronized. The workflow:

1. Checks for code quality issues
